...
/**
 * The persistent class for the test_card_identity database table.
 * 
 */
@Entity
@Table(name="test_card_identity")
@NamedQuery(name="TestCardIdentity.findAll", query="SELECT t FROM TestCardIdentity t")
public class TestCardIdentity implements Serializable {
